...
5. **CI licence allowlist**: MIT, ISC, BSD-2-Clause, BSD-3-Clause, Apache-2.0, plus EPL-2.0 for elkjs alone, checked over the dependency tree on every push. A new licence is a decision, not an accident.
