...
- **Run from disk (file://):** a single-file build cannot lazy-load budget 14's chunk; if disk support is required, that build target inlines everything and is exempt from budget 13, at about 750 KB gzipped.
